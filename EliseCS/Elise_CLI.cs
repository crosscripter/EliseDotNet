...
elise.exe <path> [<start> <stop> <fromSkip> <toSkip> <proximity> <terms..>]
	...
	{
		{Language.English, new { Formatter = typeof(LatinFormatter), Renderer = typeof(RTFGridRenderer) }},
		{Language.Greek, new { Formatter = typeof(GreekFormatter), Renderer = typeof(GreekRTFGridRenderer) }},
		{Language.Hebrew, new { Formatter = typeof(HebrewFormatter), Renderer = typeof(HebrewRTFGridRenderer) }}
	};
